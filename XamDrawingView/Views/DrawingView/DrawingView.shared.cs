...
public class DrawingView : View
{
	...
	readonly WeakEventManager drawingPointAddedEventManager = new();
	...
	/// <summary>
	/// Backing BindableProperty for the <see cref="DrawingPointAddedCommand"/> property.
	/// </summary>
	public static readonly BindableProperty DrawingPointAddedCommandProperty = BindableProperty.Create(nameof(DrawingPointAddedCommand), typeof(ICommand), typeof(DrawingView));
	...
	/// Event occured when drawing line completed
	/// </summary>
	public event EventHandler<DrawingPointAddedEventArgs> DrawingPointAdded
	{
		add => drawingPointAddedEventManager.AddEventHandler(value);
		remove => drawingPointAddedEventManager.RemoveEventHandler(value);
	}
	...
	/// This is a bindable property.
	/// </summary>
	public ICommand DrawingPointAddedCommand
	{
		get => (ICommand)GetValue(DrawingPointAddedCommandProperty);
		set => SetValue(DrawingPointAddedCommandProperty, value);
	}
	...
	/// </summary>
	/// <param name="lastDrawingLine">Last drawing line</param>
	internal void OnDrawingPointAdded(Point lastPoint)
	{
		drawingPointAddedEventManager.HandleEvent(this, new DrawingPointAddedEventArgs(lastPoint), nameof(DrawingPointAdded));
		if (DrawingPointAddedCommand?.CanExecute(lastPoint) ?? false)
			DrawingPointAddedCommand.Execute(lastPoint);
	}
}