...
using XamDrawingView.Views.DrawingView.Extensions;
...
{
	/// <summary>
	/// Android renderer for <see cref="DrawingViewRenderer"/>
	/// </summary>
		...
		public override bool OnTouchEvent(MotionEvent e)
		{
			...
			switch (e.Action)
			{
				case MotionEventActions.Down:
					...
					Element.OnDrawingPointAdded(new (touchX, touchY));
				...
				case MotionEventActions.Move:
					...
					currentLine?.Points.Add(new (touchX, touchY));
					Element.OnDrawingPointAdded(new (touchX, touchY));
