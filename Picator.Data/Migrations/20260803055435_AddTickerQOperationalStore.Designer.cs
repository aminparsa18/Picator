...
namespace Picator.Data.Migrations
{
    ...
    [Migration("20260803055435_AddTickerQOperationalStore")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Picator.Entities.Models.MatchTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Status", "Format", "CreatedDate");

                    b.ToTable("MatchTicket", "dbo");
                });
            ...
            modelBuilder.Entity("Picator.Entities.Models.Round", b =>
                {
                    ...
                    b.Property<Guid?>("ActiveGuesserGameMemberId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ActiveGuesserGameMemberId");
            ...
            modelBuilder.Entity("Picator.Entities.Models.Round", b =>
                {
                    b.HasOne("Picator.Entities.Models.GameMember", "ActiveGuesserGameMember")
                        .WithMany()
                        .HasForeignKey("ActiveGuesserGameMemberId")
                        .OnDelete(DeleteBehavior.Restrict)
                    ...
                    b.Navigation("ActiveGuesserGameMember");
